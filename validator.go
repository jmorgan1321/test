...
var (
	...
	// FloatEQ tests than two numeric values are within Epsilon of each
	// other.
	//
	// Ex:
	//  	c.Assert(test.FloatEQ, 42, 42.0, "this passes")
	//  	c.Assert(test.FloatEQ, 42, 42 + Epsilon, "this fails")
	//  	c.Assert(test.FloatEQ, 42, 42 - Epsilon, "this fails")
	//
	FloatEQ = &basic_validator{
		...
		validate_: func(v validator, args ...interface{}) bool {
			...
			return EpsilonCompare(make_float(args[0]), make_float(args[1]))
		},
	}
